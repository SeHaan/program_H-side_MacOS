...
with open(path + '/dict/dict_0_TOTAL.pickle', 'rb') as f:
    dict_0_TOTAL = pickle.load(f)
with open(path +'/dict/dict_0_ONSET.pickle', 'rb') as fo:
    dict_0_ONSET = pickle.load(fo)
with open(path +'/dict/dict_0_PEAK.pickle', 'rb') as fp:
    dict_0_PEAK = pickle.load(fp)
with open(path +'/dict/dict_0_CODA.pickle', 'rb') as fc:
